...
def no_borders(img_name):
    im = Image.open("./output/"+img_name+"_rescaled_binarized.png")
    ...
    for n in range(len(hlines)):
        ...
        matrix.append(row)
    print(matrix)
    convert(matrix, Image.open("./output/"+img_name+"_rescaled_afterpadding.png"),"./output/",img_name)



def incomplete_borders(img_name):
    im = Image.open("./output/"+img_name+"_rescaled_TextOnly.png")
    width, height = im.size
    #for h_lines
    l=[]
    threshold_count=0
    ...
    for n in range(len(hlines)):
        ...
        matrix.append(row)
    print(matrix)
    convert(matrix, Image.open("./output/"+img_name+"_rescaled_TextOnly.png"),"./output/",img_name)
